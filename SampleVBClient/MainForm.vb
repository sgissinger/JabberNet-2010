...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents roster As Muzzle.Controls.RosterTree
    Friend WithEvents debug As Muzzle.Controls.BottomScrollRichText
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.roster = New Muzzle.Controls.RosterTree
        Me.tpDebug = New System.Windows.Forms.TabPage
        Me.debug = New Muzzle.Controls.BottomScrollRichText
...
#End Region
    ...
    Private Sub Connect()
        Dim log As New Muzzle.Forms.ClientLogin(jc)
    ...
    Private Function jc_OnRegisterInfo(ByVal sender As System.Object, ByVal register As Jabber.Protocol.IQ.Register) As System.Boolean Handles jc.OnRegisterInfo
        ...
        Dim form As Muzzle.Forms.XDataForm = New Muzzle.Forms.XDataForm(data)
    ...
    Private Sub roster_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim n As Muzzle.Controls.RosterTree.ItemNode = DirectCast(roster.SelectedNode, Muzzle.Controls.RosterTree.ItemNode)
